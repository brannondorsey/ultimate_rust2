...
//! A pumpkin is a cultivated winter squash in the genus Cucurbita. The term is
//! most commonly applied to round, orange-colored squash varieties, but does
//! not possess a scientific definition. It may be used in reference to many
//! different squashes of varied appearance and belonging to multiple species in
//! the Cucurbita genus.
//!
...
pub struct Pumpkin {
    /// `percentage` of roundness from 0.0 to 1.0
    pub roundness: f32,
    /// `orangeness` rating from 8 to 27
    pub orangeness: i32,
}
...
impl Pumpkin {
    /// Smash the pumpkin. It will be gone and can't be used for pie. 😭
    pub fn smash(self) {}
}
...
/// `BURNT_ORANGE` is the default value of the [`Pumpkin::orangeness`] field in the [`Pumpkin`] struct.
...
// Answer: `cargo doc --document-private-items [...]`
